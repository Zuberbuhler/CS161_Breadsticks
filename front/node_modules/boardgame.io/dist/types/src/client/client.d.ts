 ...
 */
export declare class _ClientImpl<G extends any = any, CtxWithPlugins extends Ctx = Ctx> {
    ...
    constructor({ game, debug, numPlayers, multiplayer, matchID: matchID, playerID, credentials, enhancer, }: ClientOpts<G, CtxWithPlugins>);
 ...
 */
export declare function Client<G extends any = any, CtxWithPlugins extends Ctx = Ctx>(opts: ClientOpts<G, CtxWithPlugins>): _ClientImpl<G, CtxWithPlugins>;
